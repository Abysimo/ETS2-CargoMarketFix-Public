...
struct PluginConfig final {
    ...
    [[nodiscard]] const char* refresh_spread_refusal() const noexcept {
        ...
        if (!refresh_spread_config_valid || (refresh_spread_minutes != 60 && refresh_spread_minutes != 120 && refresh_spread_minutes != 180 && refresh_spread_minutes != 1440)) return "only_60_120_180_or_1440_minutes_supported";
