# ETS2 Cargo Market Fix v1.4.0 — ETS2 1.59.1.3

**Only ETS2 1.59.1.3, Windows x64. Do not use this DLL with another game version.**

Required eurotrucks2.exe SHA256:
`E6FE1A58DF9D0BFFF21DCCC12B4F581DC0D3E3B5885DBF62ED05028DE794D35C`

Runtime version: `1.4.0-ets2-1.59.1.3`. Other known builds and unknown executables
...
2. Download the ZIP whose name matches **ETS2 1.59.1.3**.
...
STRUCTURALLY VALIDATED. No physical Spread1440 gameplay test is claimed for this target. No measured freeze reduction, owned-trailer, sleep/bulk gameplay, or offer-quality validation is claimed.
