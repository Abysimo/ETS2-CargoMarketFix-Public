# ETS2 Cargo Market Fix v1.4.0 — ETS2 1.60.1.7

**Only ETS2 1.60.1.7, Windows x64. Do not use this DLL with another game version.**

Required eurotrucks2.exe SHA256:
`B7DFFE6B27402C7DB6DFD52CF982CD5BF292584138B35E3EB8EFB311814AB3F8`

Runtime version: `1.4.0-ets2-1.60.1.7`. Other known builds and unknown executables
...
2. Download the ZIP whose name matches **ETS2 1.60.1.7**.
...
STRUCTURALLY VALIDATED. No physical Spread1440 gameplay test is claimed for this target. No measured freeze reduction, owned-trailer, sleep/bulk gameplay, or offer-quality validation is claimed. A historical 1.60 startup smoke passed with earlier spread settings; it was not a Spread1440 gameplay test, and clean live shutdown was not confirmed.
