# ETS2 Cargo Market Fix v1.4.0 — ETS2 1.58.1.4

**Only ETS2 1.58.1.4, Windows x64. Do not use this DLL with another game version.**

Required eurotrucks2.exe SHA256:
`25CD132FB72576242C298E5EC5B6D940F2E38EBB183928AC1F16D075256BC644`

Runtime version: `1.4.0-ets2-1.58.1.4`. Other known builds and unknown executables
...
2. Download the ZIP whose name matches **ETS2 1.58.1.4**.
