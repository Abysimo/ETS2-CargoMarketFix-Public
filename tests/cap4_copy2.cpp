...
int main(){std::setvbuf(stdout,nullptr,_IONBF,0);try{
    ...
    check(fix_builds::supported.size()==6&&fix_builds::ets160.cap4_write_strategy==Strategy::quiesced_copy2&&fix_builds::ets161.cap4_write_strategy==Strategy::quiesced_copy2&&fix_builds::ets1611.cap4_write_strategy==Strategy::quiesced_copy2,"six_exact_builds_160_161_copy2");
