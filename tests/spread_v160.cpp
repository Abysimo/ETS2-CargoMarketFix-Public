...
int main(){std::setvbuf(stdout,nullptr,_IONBF,0);try{
    ...
    signatures();
    check(fix_builds::supported.size()==6&&fix_builds::identify("B7DFFE6B27402C7DB6DFD52CF982CD5BF292584138B35E3EB8EFB311814AB3F8")==&fix_builds::ets160,"real_160_exact_recognized");
